...
function atualizarProjecoes() {
    ...
    if (window.gerenciadorGraficos) {
        window.gerenciadorGraficos.atualizarGraficoProjecaoFaturamento(meses, receitas);
        window.gerenciadorGraficos.atualizarGraficoProjecaoLucro(meses, lucros);
    }
...
function atualizarDashboard() {
    ...
    if (resultados.receitaBruta) {
        ...
        if (window.gerenciadorGraficos) {
            window.gerenciadorGraficos.atualizarGraficoDashboard(dadosNegocio);
        }
    }
